...
import ScreenWidthWrapper from "../ScreenWrapper";
import useHeightReacher from "../../../hooks/useHeightReacher";
import { childrenProps } from "../../../types/interfaces";

const HeaderWrapper: React.FC<childrenProps<ReactNode>> = ({ children }) => {
        ...
        <div
            className={
                ...
                (!isReached
                    ...
                    : "bg-slate-100 supports-backdrop-blur:bg-white/95")
            }
        >
            <ScreenWidthWrapper>
                <div className="py-4">
